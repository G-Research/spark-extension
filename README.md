...
- `VERSION`: The package version, e.g. `1.4.0`.
...
```sbt
libraryDependencies += "uk.co.gresearch.spark" %% "spark-extension" % "1.4.0-3.1"
```
...
```shell script
spark-shell --packages uk.co.gresearch.spark:spark-extension_2.12:1.4.0-3.1
```
...
```shell script
pyspark --packages uk.co.gresearch.spark:spark-extension_2.11:1.4.0-2.4  # pyspark != 2.4.2
pyspark --packages uk.co.gresearch.spark:spark-extension_2.12:1.4.0-2.4  # pyspark == 2.4.2
pyspark --packages uk.co.gresearch.spark:spark-extension_2.12:1.4.0-3.1  # pyspark >= 3.0.0
```
...
```shell script
spark-submit --packages uk.co.gresearch.spark:spark-extension_2.12:1.4.0-3.1 [script.py]
```
